	...
	<section id="right" >
        <div class="tabs"><span id="p-form">Product</span><span id="c-form"> Category </span></div>
         <div id="tab1" class="table-cont">
			<h1>Product form</h1>
			<form id="add-prodt" ng-app=""  ng-controller="validateCtrl1" name="pf1"  method="post" novalidate>
		...
		function validateCtrl2($scope2) {
       // $scope2.categoryName = <?php echo $categoryName; ?>;
		}
        </script>         
    </section>
</div>
